...
const FAQS = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Do you offer free shipping?", a: "Yes. We offer free standard shipping on all orders over $80 AUD within Australia. Orders under $80 incur a flat $8 shipping fee." },
